-- Description: Expands the role validation check on staff_profiles to permit ACCOUNTANT and DEVELOPER roles natively within the database, rather than being rejected at the Postgres layer.

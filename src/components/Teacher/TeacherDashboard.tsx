            ...
            <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-indigo-700 via-indigo-600 to-purple-700 shadow-2xl shadow-indigo-300/40">
                ...
                <div className="hidden md:flex items-center justify-between gap-6 p-8 relative z-10">
                    ...
                    <div className="flex flex-col items-end gap-3 flex-shrink-0">
                        <div className="hover:scale-110 transition-transform active:scale-95" title={isSubscribed ? (subscription?.status === 'trial' ? 'Trial Mode' : 'Account Active') : 'Inactive Plan'}>
                            <SubscriptionStatusIndicator isSubscribed={isSubscribed} isLoading={isSubLoading} />
                        </div>
                        <button
                            onClick={logout}
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                                        {(stats?.classes ?? 0) > 0 && (
                                            <button
                                                ...
                                                className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all text-left flex flex-col gap-6 group hover:border-indigo-100"
                                            >
                                        ...
                                        <button
                                            ...
                                            className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all text-left flex flex-col gap-6 group hover:border-purple-100"
                                        >
                                        ...
                                        {(stats?.classes ?? 0) > 0 && (
                                            <button
                                                ...
                                                className="bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all text-left flex flex-col gap-6 group hover:border-pink-100"
                                            >
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    ...
                                                    <span className="text-[8px] font-bold text-gray-400">Term 3 Only</span>
                                                </div>
                                            </button>
                                        )}
                                    </div>
